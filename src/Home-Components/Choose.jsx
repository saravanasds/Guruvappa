...
import img from "../assets/academic.jpg"

const Choose = () => {
    return (
        <div className='w-full min-h-[80vh] flex justify-center items-center bg-slate-200'>
            <div className='w-[80%] h-[60vh] bg-white flex'>
                <div className='w-[35%] h-[60vh] border'>
                    <img src={img} alt="" className='w-full h-full object-cover'/>
                </div>
                <div className='w-[65%] h-[60vh] flex flex-col justify-center px-10 text-gray-600'>
