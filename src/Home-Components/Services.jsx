        ...
        <div className='w-full min-h-[50vh] bg-secondary '>
            <div className='w-full  bg-secondary p-4 sm:p-8 flex flex-wrap justify-center gap-4 sm:gap-8 border-secondary' >
                <div className='flex flex-col justify-center items-center cursor-pointer ' >
                    <Link to={"/infrastructure"} ><img src={stage} alt="" className='w-[100vw] h-72 sm:w-80 sm:h-80 object-cover border border-gray-400 p-1 rounded-md mb-2 hover:scale-[1.02] transform transition-all duration-500' /></Link>
                ...
                <div className='flex flex-col justify-center items-center cursor-pointer' >
                    <Link to={"/curriculam"} ><img src={Curriculum} alt="" className='w-[100vw] h-72 sm:w-80 sm:h-80 border border-gray-400 p-1 rounded-md mb-2 hover:scale-[1.02] transform transition-all duration-500 object-cover' /></Link>
                ...
                <div className='flex flex-col justify-center items-center cursor-pointer' >
                    <Link to={"/Sports"} ><img src={Sports} alt="" className='w-[100vw] h-72 sm:w-80 sm:h-80 border border-gray-400 p-1 rounded-md mb-2 hover:scale-[1.02] transform transition-all duration-500 object-cover' /></Link>
                ...
                <div className='flex flex-col justify-center items-center cursor-pointer' >
                    <Link to={"/gallery"} ><img src={cover} alt="" className='w-[100vw] h-72  sm:w-80 sm:h-80 border border-gray-400 p-1 rounded-md mb-2 hover:scale-[1.02] transform transition-all duration-500 object-cover' /></Link>
