...
const Legacy = () => {
    return (
        <div className="w-full min-h-screen p-6">
            <div className="w-[85%] mx-auto text-justify leading-relaxed">
                {/* Title */}
                <h1 className="text-3xl font-bold text-center text-prime mb-8 py-4">
                    History and Legacy of Guruvappa School
                </h1>

                {/* Founding and Establishment */}
                <section className="mb-4 py-4">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4 border-b border-black pb-2">Founding and Establishment</h2>
                    <ul className="text-lg text-gray-700 leading-relaxed list-disc ml-5 space-y-2">
                        <li>
                ...
                <section className="mb-8 ">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4 border-b border-black pb-2">Philanthropy and Contributions</h2>
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4 border-b border-black pb-2">Upgrades and Expansion</h2>
                    <ul className="text-lg text-gray-700 leading-relaxed list-disc ml-5 space-y-2">
                        <li>
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4 border-b border-black pb-2">Additional Educational schools</h2>
                    <ul className="text-lg text-gray-700 leading-relaxed list-disc ml-5 space-y-2">
                        <li>
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4  border-b border-black pb-2">Social Contributions</h2>
                    <ul className="text-lg text-gray-700 leading-relaxed list-disc ml-5 space-y-2">
                        <li>
                        ...
                        <li>
                            <strong>S.K.C Meenakshi Sundaram Memorial Hospital</strong>, a 24-hour medical facility, provides healthcare services to <strong>Neykarapatti</strong> and nearby areas.
                        </li>
                    </ul>
                </section>
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4  border-b border-black pb-2">Public Welfare and Extra-Curricular Activities</h2>
                    <ul className="text-lg text-gray-700 leading-relaxed list-disc ml-5 space-y-2">
                        <li>
                            The school has been running a <strong>National Student Corps (NCC)</strong> program since <strong>2010,</strong> with students participating in <strong>camps</strong> and receiving <strong>shooting training.</strong>
                        </li>
                ...
                {/* Recent Developments */}
                <section className="mb-8">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4  border-b border-black pb-2">Recent Developments</h2>
                    <ul className="text-lg text-gray-700 leading-relaxed list-disc ml-5 space-y-2">
                        <li>
                ...
                {/* Conclusion */}
                <section className='mb-8'>
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4 border-b border-black pb-2">Conclusion</h2>
                    <p className="text-lg text-gray-700 leading-relaxed">
