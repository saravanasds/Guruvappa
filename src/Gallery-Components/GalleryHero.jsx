    ...
    return (
        <div className='relative w-full min-h-[40vh] sm:min-h-[60vh] flex justify-start items-end'>
            ...
            <div className='relative my-4 sm:my-6 mx-4 sm:mx-20'>
                <h2 className='text-white text-2xl sm:text-3xl md:text-4xl font-bold tracking-wider flex gap-3' style={{ textShadow: "4px 4px 0px black" }}><TiArrowForwardOutline className='mt-2' />Photos & Collections <RiArrowDownDoubleLine className='mt-2' /></h2>
            </div>
        </div>
    )
}
